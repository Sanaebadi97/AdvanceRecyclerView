package ir.ncbox.libarary.adapter;
 ...
 */
public abstract class AdvanceRecyclerViewAdapter<T, VH extends RecyclerView.ViewHolder> extends BaseRecyclerViewAdapter<T> {

    public AdvanceRecyclerViewAdapter(Context context) {
        super(context);
    }
